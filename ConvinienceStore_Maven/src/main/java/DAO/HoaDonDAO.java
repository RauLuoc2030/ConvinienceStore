...
public class HoaDonDAO {
    ...
    public ArrayList<HoaDonDTO> ReadDB(String condition, String orderby) throws Exception {
        ...
        while (result.next()) {
            ...
            hoaDon.setTenNVBanHangHDString(result.getString("TENNV"));
            hoaDon.setTenKhachHangHDString(result.getString("TENKH"));
    ...
    public Boolean them(HoaDonDTO hoadon) throws Exception {
        ...
        try {
            ...
            pst.setString(3, hoadon.getTenNVBanHangHDString());
            pst.setString(4, hoadon.getTenKhachHangHDString());
