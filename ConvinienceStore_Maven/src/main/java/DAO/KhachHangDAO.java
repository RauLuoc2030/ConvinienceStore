...
public class KhachHangDAO {
    ...
    public ArrayList<KhachHangDTO> ReadDB(String condition, String orderby) throws Exception {
        ...
        while (result.next()) {
            ...
            khachHang.setTenKHString(result.getString("TenKH"));
            khachHang.setMaHDString(result.getString("MaHD"));
    ...
    public Boolean them(KhachHangDTO khachHang) throws Exception {
        ...
        try {
            ...
            pst.setString(2, khachHang.getTenKHString());
            pst.setString(3, khachHang.getMaHDString());
