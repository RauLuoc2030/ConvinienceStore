...
public class HoaDonDTO {
    ...
    /**
     * Chỉ cần SDT của khách hàng thì có thể biết được hóa đơn này do khách nào mua
     */
    @Column(name = "SDTKH")
    ...
    /**
     * Dùng để cấu hình mối quan hệ ManyToOne giữa Hóa đơn và Nhân viên:
     * Nhiều Hóa đơn có thể được tạo bởi một Nhân viên
     */
    @ManyToOne
